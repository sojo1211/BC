...
export const DISTRICT_RUNNING_COURSES: Record<string, DistrictCourse> = {
  ...
  "강남구": {
    name: "양재천 메타세쿼이아 수변 순환로",
    distance: "5.6km",
    level: "초보~중급",
    description: "도곡동 타워팰리스 부근 양재천 탄천 합수부까지 이어지는 완벽한 우레탄 트랙 코스",
    path: [
      [37.4855, 127.0425], // 양재천 영동2교
      [37.4870, 127.0480], // 도곡역 남단 수변트랙
      [37.4890, 127.0545], // 대치교 메타세쿼이아길
      [37.4930, 127.0620], // 탄천 합수부 쉼터
      [37.4975, 127.0685], // 학여울역 세텍 수변로
      [37.4940, 127.0620], // 반환 수변길
      [37.4895, 127.0530], // 개포동 양재천 보행로
      [37.4865, 127.0460], // 영동3교 하부
      [37.4855, 127.0425]
    ]
  },
  "영등포구": {
  ...
  "용산구": {
    name: "이촌 한강공원 & 용산가족공원런",
    distance: "4.9km",
    level: "누구나 환영",
    description: "국립중앙박물관 거울못 정원에서 한강 이촌지구 수변 자전거길로 연결되는 평지 코스",
    path: [
      [37.5235, 126.9805], // 국립중앙박물관 입구
      [37.5210, 126.9780], // 용산가족공원 둘레길
      [37.5175, 126.9760], // 이촌역 나들목
      [37.5155, 126.9720], // 이촌 한강공원 수변 트랙
      [37.5180, 126.9650], // 한강대교 북단 쉼터
      [37.5215, 126.9680], // 이촌로 보행로
      [37.5240, 126.9740], // 신용산 방면 도로
      [37.5235, 126.9805]
    ]
  },
  "성동구": {
    ...
    distance: "5.1km",
    level: "초보~중급",
    description: "서울숲 은행나무숲에서 한강 합수부를 지나 살곶이다리를 건너는 자연 친화 코스",
    path: [
      [37.5445, 127.0375], // 서울숲 야외무대
      [37.5410, 127.0420], // 서울숲 거울연못
      [37.5385, 127.0460], // 한강수변공원 연결로
      [37.5450, 127.0540], // 중랑천 합수부 산책로
      [37.5510, 127.0570], // 살곶이다리 역사쉼터
      [37.5550, 127.0490], // 응봉체육공원 수변길
      [37.5490, 127.0400], // 서울숲 뚝섬나들목
      [37.5445, 127.0375]
    ]
  },
  "서초구": {
    name: "반포 한강 달빛무지개 분수런",
    distance: "5.3km",
    level: "초보 환영",
    description: "세빛섬과 달빛무지개분수 야경을 정면으로 마주하며 달리는 반포 한강 대표 수변로",
    path: [
      [37.5115, 126.9945], // 반포한강공원 달빛광장
      [37.5135, 126.9920], // 세빛섬 앞 수변데크
      [37.5150, 126.9870], // 동작대교 남단 하부
      [37.5100, 126.9880], // 반포천 합수부 산책로
      [37.5050, 126.9930], // 고속터미널 앞 보행로
      [37.5080, 126.9990], // 잠수교 진입 쉼터
      [37.5115, 126.9945]
    ]
  },
  "관악구": {
